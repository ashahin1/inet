...
#include "inet/mobility/single/ConnectedGraphMassMobility.h"

namespace inet {

Define_Module(ConnectedGraphMassMobility);

double ConnectedGraphMassMobility::previousNodeX = -1;
double ConnectedGraphMassMobility::previousNodeY = -1;
double ConnectedGraphMassMobility::previousNodeZ = -1;

void ConnectedGraphMassMobility::setInitialPosition() {
